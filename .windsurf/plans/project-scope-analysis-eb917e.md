...
1. ระบบรองรับผู้ใช้งาน 3 บทบาท ได้แก่ ผู้ว่าจ้าง (Hirer) ผู้ดูแล (Caregiver) และผู้ดูแลระบบ (Admin) โดยผู้ว่าจ้างและผู้ดูแลสามารถสมัครสมาชิกได้ 2 รูปแบบ คือ Guest (สมัครด้วยอีเมล) และ Member (สมัครด้วยเบอร์โทรศัพท์) รวมถึงรองรับการเข้าสู่ระบบผ่าน Google OAuth
...
1. **ระบบยืนยันตัวตนและจัดการบัญชี**: รองรับการสมัครสมาชิกด้วยอีเมลหรือเบอร์โทรศัพท์ การเข้าสู่ระบบผ่าน Google OAuth การยืนยัน OTP ผ่านอีเมลและ SMS (ใช้ SMSOK เป็นผู้ให้บริการ) การลืมรหัสผ่าน การจัดการโปรไฟล์ และการอัปโหลดรูปโปรไฟล์พร้อมครอปรูป
