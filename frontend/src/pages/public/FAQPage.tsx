...
export default function FAQPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'L0→L1: ยืนยันเบอร์โทร | L1→L2: ผ่านการตรวจสอบ KYC | L2→L3: ยืนยันบัญชีธนาคาร + มี Trust Score ≥ 80 จากการทำงานที่มีคุณภาพ',
    },
    {
      category: 'caregiver',
      question: 'ฉันจะรับเงินเมื่อไหร่?',
      answer:
        'เงินจะถูกจ่ายทันทีหลังจากงานเสร็จสมบูรณ์และคุณเช็คเอาต์สำเร็จ (พร้อมหลักฐาน GPS และรูปภาพ) เงินจะเข้ากระเป๋าเงินของคุณทันที และสามารถขอถอนได้เมื่อ Trust Level ถึง L2 ขึ้นไป',
    },
    ...
    },
    {
      ...
      answer:
        'ผู้ดูแลที่มี Trust Level L2 ขึ้นไป สามารถขอถอนเงินได้โดยเพิ่มบัญชีธนาคาร ทีมงานจะตรวจสอบและโอนเงินภายใน 1-3 วันทำการ',
    },
