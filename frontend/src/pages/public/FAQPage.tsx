...
export default function FAQPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'Guest สมัครด้วยอีเมล ใช้สำรวจระบบได้ แต่ไม่สามารถสร้างหรือรับงานได้ Member สมัครด้วยเบอร์โทรและยืนยัน OTP สามารถใช้งานเต็มรูปแบบได้ตามระดับความน่าเชื่อถือ',
    },
