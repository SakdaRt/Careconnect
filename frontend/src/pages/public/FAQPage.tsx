...
export default function FAQPage() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'การลงทะเบียนไม่มีค่าใช้จ่าย สามารถสมัครและใช้งานฟรี ระบบจะหักค่าบริการเฉพาะเมื่อมีการทำงานสำเร็จเท่านั้น',
    },
    {
      category: 'general',
      question: 'ต่างระหว่าง Guest และ Member อย่างไร?',
      answer:
        'Guest สมัครด้วยอีเมล ใช้สำรวจระบบได้ แต่ไม่สามารถสร้างหรือรับงานได้ Member สมัครด้วยเบอร์โทรและยืนยันรหัส สามารถใช้งานเต็มรูปแบบได้ตามระดับความน่าเชื่อถือ',
    },
    ...
    },
    {
      ...
      answer:
        'ระบบมีระดับความน่าเชื่อถือ 4 ระดับ (เริ่มต้น, ยืนยันการติดต่อ, ยืนยันตัวตน, มืออาชีพ) รวมถึงประวัติการทำงาน รีวิวจากผู้ใช้งานอื่น และการตรวจสอบ KYC ยิ่งระดับสูง ยิ่งได้รับความไว้วางใจมากขึ้น',
    },
    {
      category: 'hirer',
    ...
    // Caregiver
    {
      ...
      answer:
        'ต้องมีอายุ 18 ปีขึ้นไป มีประสบการณ์หรือความสามารถในการดูแลผู้สูงอายุ และผ่านการตรวจสอบ KYC สำหรับงานความเสี่ยงสูงต้องยืนยันตัวตนก่อน',
    },
    {
      category: 'caregiver',
      question: 'ฉันจะเพิ่มระดับความน่าเชื่อถือได้อย่างไร?',
      answer:
        'ยืนยันอีเมลและเบอร์โทรทั้งคู่ (ยืนยันการติดต่อ) → ยืนยันตัวตน KYC (ยืนยันตัวตน) → เพิ่มบัญชีธนาคาร + ทำงานสะสมคะแนนสูง (มืออาชีพ) สำหรับผู้ดูแล: งานความเสี่ยงสูงต้องอัปโหลดเอกสาร/ใบรับรองเพิ่มเติม',
    },
    {
      category: 'caregiver',
      question: 'ฉันจะรับเงินเมื่อไหร่?',
      answer:
        'เงินจะถูกจ่ายทันทีหลังจากงานเสร็จสมบูรณ์และคุณเช็คเอาต์สำเร็จ (พร้อมหลักฐาน GPS และรูปภาพ) เงินจะเข้ากระเป๋าเงินของคุณทันที และสามารถขอถอนได้เมื่อยืนยันตัวตนแล้ว',
    },
    ...
    },
    {
      ...
      answer:
        'ผู้ดูแลที่ยืนยันตัวตนแล้ว สามารถขอถอนเงินได้โดยเพิ่มบัญชีธนาคาร ทีมงานจะตรวจสอบและโอนเงินภายใน 1-3 วันทำการ',
    },
    ...
    },
    {
      ...
      answer:
        'ข้อมูลทั้งหมดถูกเข้ารหัสและจัดเก็บอย่างปลอดภัย ข้อมูลผู้ป่วยจะถูกเปิดเผยเฉพาะผู้ดูแลที่รับงานเท่านั้น และจำกัดตามระดับความน่าเชื่อถือ',
    },
    {
      category: 'safety',
