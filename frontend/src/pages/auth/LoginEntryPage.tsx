  ...
  return (
    <AuthLayout>
      <div className="bg-white rounded-lg shadow-md p-6 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-2">เข้าสู่ระบบ</h1>
        <p className="text-gray-600 text-center mb-6 sm:mb-8">เลือกวิธีการเข้าสู่ระบบ</p>
