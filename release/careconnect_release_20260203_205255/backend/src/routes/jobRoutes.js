 ...
 */
router.get('/feed', requireAuth, requireRole('caregiver'), getJobFeed);
 ...
 */
router.get('/my-jobs', requireAuth, requireRole('hirer'), getHirerJobs);
 ...
 * Query: { status?, page?, limit? }
 */
router.get('/assigned', requireAuth, requireRole('caregiver'), getCaregiverJobs);
 ...
 * }
 */
router.post('/', requireAuth, requireRole('hirer'), validateBody(createJobSchema), createJob);
 ...
 * Headers: Authorization: Bearer <token>
 */
router.post('/:id/publish', requireAuth, requireRole('hirer'), publishJob);
 ...
 * Headers: Authorization: Bearer <token>
 */
router.post('/:id/accept', requireAuth, requireRole('caregiver'), acceptJob);
 ...
 */
router.post('/:jobId/checkin', requireAuth, requireRole('caregiver'), validateBody(gpsSchema), checkIn);
 ...
 * Body: { lat?, lng?, accuracy_m? }
 */
router.post('/:jobId/checkout', requireAuth, requireRole('caregiver'), validateBody(gpsSchema), checkOut);
 ...
 * Body: { reason }
 */
router.post('/:id/cancel', requireAuth, validateBody(cancelSchema), cancelJob);
