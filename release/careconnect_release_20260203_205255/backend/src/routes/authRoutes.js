 ...
 * Headers: Authorization: Bearer <token>
 */
router.put('/profile', requireAuth, validateBody(profileSchema), updateMyProfile);

router.post('/phone', requireAuth, validateBody(updatePhoneSchema), updatePhoneNumber);
router.post('/email', requireAuth, validateBody(updateEmailSchema), updateEmailAddress);
router.post('/policy/accept', requireAuth, validateBody(policyConsentSchema), acceptPolicyConsent);
router.post('/role', requireAuth, validateBody(updateRoleSchema), updateRole);
