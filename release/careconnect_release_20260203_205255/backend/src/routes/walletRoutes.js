 ...
 */
router.get('/bank-accounts', requireAuth, requireRole('caregiver'), walletController.getBankAccounts);

/**
 * Add bank account (caregiver)
 * POST /api/wallet/bank-accounts
 */
router.post('/bank-accounts', requireAuth, requireRole('caregiver'), validateBody(addBankAccountSchema), walletController.addBankAccount);
 ...
 * Headers: Authorization: Bearer <token>
 */
router.get('/topup/pending', requireAuth, walletController.getPendingTopups);
 ...
 */
router.post('/topup', requireAuth, validateBody(topupSchema), walletController.initiateTopup);
 ...
 * Headers: Authorization: Bearer <token>
 */
router.get('/topup/:topupId', requireAuth, walletController.getTopupStatus);
 ...
 */
router.post('/withdraw', requireAuth, requireRole('caregiver'), validateBody(withdrawSchema), walletController.initiateWithdrawal);
 ...
 * Headers: Authorization: Bearer <token>
 */
router.post('/withdrawals/:withdrawalId/cancel', requireAuth, walletController.cancelWithdrawal);
